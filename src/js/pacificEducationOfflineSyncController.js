 ...
 * v1.0.0 — prototype reconciliation only
 * No client-side code may claim server synchronization succeeded.
 */
(function(window){
"use strict";
var VERSION="1.0.0";
...
window.PacificEducationOfflineSyncController=Object.freeze({name:"PacificEducationOfflineSyncController",version:VERSION,inspect:inspect,attemptSync:attemptSync,clearAfterServerAcknowledgement:clearAfterServerAcknowledgement,status:status});
})(window);
