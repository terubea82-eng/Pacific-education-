...
function verify(){
 ...
 var rg=resolution&&resolution.verify?resolution.verify():null,og=outcome&&outcome.verify?outcome.verify():null,cg=closure&&closure.verify?closure.verify():null;
