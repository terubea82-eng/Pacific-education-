...
function boot(){initialize();return{connection:validateConnection(),validation:window.PacificEducationCurriculumValidationGuard?window.PacificEducationCurriculumValidationGuard.runFullValidation():null};}
window.PacificEducationCurriculumDailyLessonsBridge=Object.freeze({name:"PacificEducationCurriculumDailyLessonsBridge",version:VERSION,initialize:initialize,boot:boot,validateConnection:validateConnection,generateDailyLesson:generateDailyLesson,recordTeacherEvidence:recordTeacherEvidence,getAssessmentForIndicator:getAssessmentForIndicator,getIntegrationForIndicator:getIntegrationForIndicator,getCalendarStatus:getCalendarStatus});})(window);