...
function authorizeAccess(request) {
  ...
  /*
   * SECURITY REQUIREMENT:
   * LINK_RULES is the canonical permission boundary.
   * Client-side stored permissions are never sufficient
   * to create a permission that the canonical rule does
   * not allow.
   */
  ...
  /*
   * The stored authorized link must also contain the
